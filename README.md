...
-  Проверка остатка на таймере происходит не мгновенно, а раз в **секунду**. Так, например, когда таймер показывает 0 секунд у игрока есть возможность спастись, передав ход.
