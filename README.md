...
-  Время активного игрока уменьшается не мгновенно, а **раз в секунду**.
-  Проверка остатка на таймере происходит также не мгновенно, а **раз в секунду**. Поэтому, когда у игрока на табло 0 секунд (а по-настоящему это может быть время < 0) он имеет возможность спастись, передав ход.
